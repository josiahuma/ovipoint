/*
  ...
  - You are about to drop the column `smsContactPhone` on the `church` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `church` DROP COLUMN `smsContactPhone`,
    ADD COLUMN `admin_email` VARCHAR(191) NULL,
    ADD COLUMN `password_hash` VARCHAR(191) NULL,
    ADD COLUMN `sms_contact_phone` VARCHAR(191) NULL;
